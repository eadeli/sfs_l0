function [alpha, beta] = LogisticL0(X,y,k,k1,k2,tol,M,maxiter)
% Logistic loss + L0 regularizer
...
while err>tol && itx<maxiter
    ...
    A = X(alpha0>1e-8,:);
    b = y(alpha0>1e-8);
    [beta1,~] = PD_logreg(A,b,'SM',k,tol,M,maxiter,beta0);
